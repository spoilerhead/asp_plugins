...
///////////////////////////////////////////////////////////////////////////////
bool convolve2DSeparable(int* in, int* out, const int dataSizeX, const int dataSizeY, 
                         float* kernelX, const int kSizeX, float* kernelY, const int kSizeY)
{
    int i, j, k, m, n;
    float *tmp, *sum;                               // intermediate data buffer
...
bool convolve2DSeparable(float* in, float* out, int dataSizeX, int dataSizeY, 
                         const float* kernelX, const int kSizeX, const float* kernelY, const int kSizeY)
{
    int i, j, k, m, n;
    float *tmp, *sum;                               // intermediate data buffer
