#ifndef DenoisePLUGIN_H
#define DenoisePLUGIN_H
...
class DenoisePlugin : public QObject, public B5Plugin
{
Q_OBJECT
public:
	DenoisePlugin() { ; }
	virtual int priority() { return 100; }
	virtual QString name() { return QString("WaveletDenoise2"); }
	virtual QString group() { return QString("WaveletDenoise2"); }
